     ...
     <div class="col-5 col-md-6 col-lg-4 mx-auto">
            <div class="card">
                <div class="card-header text-center bg-info text-dark">
                    <h3 runat="server" id="nombrePaginaTxt" class="p-2">Actualizar Punto de Carga</h3>
                </div>
                 ...
                 <div class="card-body">
                    ...
                    <div class="mt-3">
                        <asp:button runat="server" class="btn btn-primary" OnClick="Actualizar_Click" type="submit" Text="Actualizar"></asp:button>
                    </div>                  
